...
In this module, you will handle values that can have more than one type.
...
- handle values that can have more than one type
...
```bash
tsx 05_unions_and_narrowing/index.ts
```
