...
In this module, you will practice reading the shape of Java code.
...
```bash
javac 02_java_syntax/Main.java
java -cp 02_java_syntax Main
```
...
Reading the shape of java code is one small part of programming. You will see the idea in the README first, then in `Main.java`.
