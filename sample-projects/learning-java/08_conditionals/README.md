...
```bash
javac 08_conditionals/Main.java
java -cp 08_conditionals Main
```
...
Making decisions is one small part of programming. You will see the idea in the README first, then in `Main.java`.
