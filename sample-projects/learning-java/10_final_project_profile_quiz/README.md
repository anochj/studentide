...
In this module, you will practice building a friendly profile quiz.
...
```bash
javac 10_final_project_profile_quiz/Main.java
java -cp 10_final_project_profile_quiz Main
```
...
Building a friendly profile quiz is one small part of programming. You will see the idea in the README first, then in `Main.java`.
