...
In this module, you will practice asking the user questions.
...
```bash
javac 07_input/Main.java
java -cp 07_input Main
```
...
Asking the user questions is one small part of programming. You will see the idea in the README first, then in `Main.java`.
