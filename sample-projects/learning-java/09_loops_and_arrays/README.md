...
In this module, you will practice repeating code and storing groups of values.
...
```bash
javac 09_loops_and_arrays/Main.java
java -cp 09_loops_and_arrays Main
```
...
Repeating code and storing groups of values is one small part of programming. You will see the idea in the README first, then in `Main.java`.
