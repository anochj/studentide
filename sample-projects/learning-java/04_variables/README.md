...
In this module, you will practice storing values in variables.
...
```bash
javac 04_variables/Main.java
java -cp 04_variables Main
```
...
Storing values in variables is one small part of programming. You will see the idea in the README first, then in `Main.java`.
