...
In this module, you will practice using numbers and simple math.
...
```bash
javac 06_numbers_and_math/Main.java
java -cp 06_numbers_and_math Main
```
...
Using numbers and simple math is one small part of programming. You will see the idea in the README first, then in `Main.java`.
