...
In this module, you will practice working with text.
...
```bash
javac 05_strings/Main.java
java -cp 05_strings Main
```
...
Working with text is one small part of programming. You will see the idea in the README first, then in `Main.java`.
