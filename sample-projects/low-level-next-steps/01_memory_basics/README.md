...
In this module, you will practice seeing addresses and values.
...
Seeing addresses and values is one small part of programming. You will see the idea in the README first, then in `main.c`.
