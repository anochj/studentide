...
In this module, you will practice moving through arrays.
...
```bash
gcc -Wall -Wextra -std=c11 03_arrays_and_pointer_math/main.c -o 03_arrays_and_pointer_math/main
./03_arrays_and_pointer_math/main
```
...
Moving through arrays is one small part of programming. You will see the idea in the README first, then in `main.c`.
