...
In this module, you will practice building a small records tool.
...
```bash
gcc -Wall -Wextra -std=c11 07_final_project_cli_records/main.c -o 07_final_project_cli_records/main
./07_final_project_cli_records/main
```
...
Building a small records tool is one small part of programming. You will see the idea in the README first, then in `main.c`.
