...
In this module, you will practice saving structured records.
...
```bash
gcc -Wall -Wextra -std=c11 05_structs_and_files/main.c -o 05_structs_and_files/main
./05_structs_and_files/main
```
...
Saving structured records is one small part of programming. You will see the idea in the README first, then in `main.c`.
