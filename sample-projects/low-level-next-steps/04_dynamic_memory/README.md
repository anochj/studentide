...
In this module, you will practice allocating and freeing memory.
...
```bash
gcc -Wall -Wextra -std=c11 04_dynamic_memory/main.c -o 04_dynamic_memory/main
./04_dynamic_memory/main
```
...
Allocating and freeing memory is one small part of programming. You will see the idea in the README first, then in `main.c`.
