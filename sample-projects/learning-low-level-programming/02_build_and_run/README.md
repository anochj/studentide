...
In this module, you will practice compiling source code.
...
```bash
gcc 02_build_and_run/main.c -o 02_build_and_run/main
./02_build_and_run/main
```
...
Compiling source code is one small part of programming. You will see the idea in the README first, then in `main.c`.
