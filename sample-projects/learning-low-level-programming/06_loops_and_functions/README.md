...
In this module, you will practice repeating work and reusing code.
...
```bash
gcc 06_loops_and_functions/main.c -o 06_loops_and_functions/main
./06_loops_and_functions/main
```
...
Repeating work and reusing code is one small part of programming. You will see the idea in the README first, then in `main.c`.
