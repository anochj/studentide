...
In this module, you will practice building a small state tracker.
...
```bash
gcc 08_final_project_state_tracker/main.c -o 08_final_project_state_tracker/main
./08_final_project_state_tracker/main
```
...
Building a small state tracker is one small part of programming. You will see the idea in the README first, then in `main.c`.
...
### Challenge 1
Change one printed message.

### Challenge 2
Compile and run again.

### Challenge 3
Delete the compiled `main` file when you are done testing.
