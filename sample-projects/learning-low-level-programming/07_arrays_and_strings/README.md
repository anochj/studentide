...
In this module, you will practice working with groups of values.
...
```bash
gcc 07_arrays_and_strings/main.c -o 07_arrays_and_strings/main
./07_arrays_and_strings/main
```
...
Working with groups of values is one small part of programming. You will see the idea in the README first, then in `main.c`.
