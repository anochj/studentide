...
In this module, you will practice storing typed values.
...
```bash
gcc 03_variables_and_types/main.c -o 03_variables_and_types/main
./03_variables_and_types/main
```
...
Storing typed values is one small part of programming. You will see the idea in the README first, then in `main.c`.
