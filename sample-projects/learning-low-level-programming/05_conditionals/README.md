...
In this module, you will practice making decisions.
...
```bash
gcc 05_conditionals/main.c -o 05_conditionals/main
./05_conditionals/main
```
...
Making decisions is one small part of programming. You will see the idea in the README first, then in `main.c`.
