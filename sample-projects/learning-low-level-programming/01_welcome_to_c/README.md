...
In this module, you will practice printing your first C program.
...
Printing your first c program is one small part of programming. You will see the idea in the README first, then in `main.c`.
