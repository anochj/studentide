...
In this module, you will practice working with ArrayList values.
...
```bash
javac 03_lists_and_loops/Main.java
java -cp 03_lists_and_loops Main
```
...
Working with arraylist values is one small part of programming. You will see the idea in the README first, then in `Main.java`.
