...
In this module, you will practice saving and reading simple text files.
...
```bash
javac 05_file_input_output/Main.java
java -cp 05_file_input_output Main
```
...
Saving and reading simple text files is one small part of programming. You will see the idea in the README first, then in `Main.java`.
