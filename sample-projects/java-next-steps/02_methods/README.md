...
In this module, you will practice moving repeated work into methods.
...
```bash
javac 02_methods/Main.java
java -cp 02_methods Main
```
...
Moving repeated work into methods is one small part of programming. You will see the idea in the README first, then in `Main.java`.
