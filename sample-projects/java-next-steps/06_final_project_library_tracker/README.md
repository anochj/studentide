...
In this module, you will practice building a small library checkout tracker.
...
- read slightly larger Java code
...
```bash
javac 06_final_project_library_tracker/Main.java
java -cp 06_final_project_library_tracker Main
```
...
Building a small library checkout tracker is one small part of programming. You will see the idea in the README first, then in `Main.java`.

## Open the file

Open [Main.java](Main.java).
