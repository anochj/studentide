...
In this module, you will practice finding matching values.
...
```bash
javac 04_searching_and_filtering/Main.java
java -cp 04_searching_and_filtering Main
```
...
Finding matching values is one small part of programming. You will see the idea in the README first, then in `Main.java`.
